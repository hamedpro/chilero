...
<center>
<h2 style="font-size: 3em; color:yellow;"><?php echo "Error help Page (18)"."</br>"; ?></h2>
</center>
...
<center>
  ...
  <button class="button" align="middle"  id="exit_btn" type="button"  onclick="exit_btn_click()" ><?php echo 'Exit'; ?> </button>  
