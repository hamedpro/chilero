...
<center>
<h2 style="font-size: 3em; color:yellow;"><?php echo "General Settings Page (32)"."</br>"; ?></h2>
</center>
...
<center>
  <button class="button" align="middle"  id="reset_btn" type="button"  onclick="reset_btn_click()" ><?php echo 'Reset'; ?> </button>  
  <button class="button" align="middle"  id="auto_start_btn" type="button"  onclick="auto_start_btn_click()" ><?php echo 'Auto<br>Start'; ?> </button>  
 <button class="button" align="middle"  id="buzzer_btn" type="button"  onclick="buzzer_btn_click()" ><?php echo 'Buzzer'; ?> </button>
