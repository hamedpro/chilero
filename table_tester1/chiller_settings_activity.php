...
<center>
<h2 style="font-size: 3em; color:yellow;"><?php echo "Settings Page (3)"."</br>"; ?></h2>
</center>
...
var string = "["+JSON.stringify(obj)+"]";
 ...
 function general_settings_btn_click(){
      trigger="1";
     desired_hostpage="32";
...
<center>
  <button class="button" align="middle"  id="set_point_btn" type="button"  onclick="set_point_btn_click()" ><?php echo 'Set Point'; ?> </button>  
  <button class="button" align="middle"  id="system_settings_btn" type="button"  onclick="system_settings_btn_click()" ><?php echo 'System<br>Settings'; ?> </button>  
 <button class="button" align="middle"  id="general_settings_btn" type="button"  onclick="general_settings_btn_click()" ><?php echo 'General<br>Settings'; ?> </button>
