...
<center>
<h2 style="font-size: 3em; color:yellow;"><?php echo "Check Page (21)"."</br>"; ?></h2>
</center>
...
<center>
  <button class="button" align="middle"  id="diagram_btn" type="button"  onclick="diagram_btn_click()" ><?php echo 'Diagram'; ?> </button>  
  <button class="button" align="middle"  id="temperature_btn" type="button"  onclick="temperature_btn_click()" ><?php echo 'Temperature'; ?> </button>  
 <button class="button" align="middle"  id="switch_pressure_btn" type="button"  onclick="switch_pressure_btn_click()" ><?php echo 'Switch<br>&<br>pressure'; ?> </button>
 <button class="button" align="middle"  id="electrical_history_btn" type="button"  onclick="electrical_history_btn_click()" ><?php echo 'Electrical<br>&<br>History'; ?> </button>
