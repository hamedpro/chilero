...
<center>
<h2 style="font-size: 3em; color:yellow;"><?php echo "Reset Warning Page (8)"."</br>"; ?></h2>
</center>
...
<center>
  <button class="button" align="middle"  id="yes_btn" type="button"  onclick="yes_btn_click()" ><?php echo 'Yes'; ?> </button>  
  <button class="button" align="middle"  id="no_btn" type="button"  onclick="no_btn_click()" ><?php echo 'No'; ?> </button>  
