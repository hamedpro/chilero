...
<center>
<h2 style="font-size: 3em; color:yellow;"><?php echo "Main Page (1)"."</br>"; ?></h2>
</center>
...
var trigger="0";
var jstart_btn_text="Start";
var j_hostpage="1";
var desired_hostpage="1";
var Starton="0";
var Startonhelp="11";

var feedback_wait_counter=0;
...
//==================================================================
 ...
 xhttp.onreadystatechange = function() {
  ...
  xhttp.open("POST","table_output.php?q=" + str, true);
  xhttp.send();  
    ...
    var file_text=(this.responseText);   
     document.getElementById("data_content").innerHTML =file_text;
       ...
       var obj = JSON.parse(file_text);
        ...
        jstart_btn_text=obj[0].j_Start_button;
        
        j_hostpage=obj[0].j_hostpage;
...
obj.k_Starton = Starton;
obj.k_Startonhelp = Startonhelp;
...
var string = "["+JSON.stringify(obj)+"]";
 ...
 xhttp.onreadystatechange = function() {
  ...
  function myTimer() {
    ...
    if(feedback_wait_counter>0)
    feedback_wait_counter--;
    
    if(jstart_btn_text=="Stop" && feedback_wait_counter == 0){
         Starton="1";
         document.querySelector('#start').innerText = 'Stop';
    document.querySelector('#start').style.color = "red";
    }
    else
    if(jstart_btn_text=="Start" && feedback_wait_counter == 0){
         Starton="0"; 
         document.querySelector('#start').innerText = 'Start';
    document.querySelector('#start').style.color = "white";
    }
...
<center>
<button class="button" align="middle"  id="menu_btn" type="button"  onclick="menu_btn_click()" ><?php echo 'Menu'; ?> </button> 
<button class="button" align="middle"  id="start" type="button"  onclick="start_btn_click()" ><?php echo 'Start'; ?> </button>
<button class="button" align="middle"  id="error" type="button"  onclick="error_btn_click()" ><?php echo 'Error'; ?> </button>
</center>
