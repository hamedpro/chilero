...
<center>
<h2 style="font-size: 3em; color:yellow;"><?php echo "Menu Page (2)"."</br>"; ?></h2>
</center>
...
<center>
  <button class="button" align="middle"  id="settings_btn" type="button"  onclick="settings_btn_click()" ><?php echo 'Settings'; ?> </button>  
  <button class="button" align="middle"  id="manual_btn" type="button"  onclick="manual_btn_click()" ><?php echo 'Manual'; ?> </button>  
 <button class="button" align="middle"  id="check_btn" type="button"  onclick="check_btn_click()" ><?php echo 'Check'; ?> </button>   
